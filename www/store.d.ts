...
declare namespace CdvPurchase {
     ...
     */
    type PlatformWithOptions = PlatformOptions.Braintree | PlatformOptions.AppleAppStore | PlatformOptions.GooglePlay | PlatformOptions.Test | PlatformOptions.WindowsStore | PlatformOptions.IapticJS | PlatformOptions.AmazonAppStore;
    /** @internal */
    namespace Internal {
...
declare namespace CdvPurchase {
    namespace Validator {
        namespace Request {
            ...
            type ApiValidatorBodyTransaction = ApiValidatorBodyTransactionApple | ApiValidatorBodyTransactionGoogle | ApiValidatorBodyTransactionWindows | ApiValidatorBodyTransactionBraintree | ApiValidatorBodyTransactionIaptic | ApiValidatorBodyTransactionAmazon;
